...
//                    "com.iqoo.secure/.ui.phoneoptimize.AddWhiteListActivity", //这是白名单, 不是自启动
    ...
    public static void showDialog(Activity activity){
        if(activity.getSharedPreferences("appstartpage",Context.MODE_PRIVATE).getBoolean("hasOpened",false)){
            return;
        }
        ...
        AlertDialog dialog = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton(R.string.c_sure, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        startToAutoStartSetting(activity);
                    }
    ...
    public static void startToAutoStartSetting(Context context) {
        ...
        /*if(context.getSharedPreferences("appstartpage",Context.MODE_PRIVATE).getBoolean("hasOpened",false)){
            return;
        }*/

        context.getSharedPreferences("appstartpage",Context.MODE_PRIVATE).edit().putBoolean("hasOpened",true).apply();
